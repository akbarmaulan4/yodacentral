...
class OTREntryScreen extends StatefulWidget {
  const OTREntryScreen({Key? key}) : super(key: key);

  @override
  _OTRDetaultScreenState createState() => _OTRDetaultScreenState();
}

class _OTRDetaultScreenState extends State<OTREntryScreen> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text('OTR Entry', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
            ),
            Expanded(
              child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        btnKirim(
                          ...
                          text: 'Hitung Kredit',
                          onClick: ()=>controller.calculateOTREntry(
                            context: context,
